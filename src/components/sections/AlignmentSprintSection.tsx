...
const AlignmentSprintSection = () => (
  <AnimatedSection id="initial-phase">
    <div className="w-full max-w-[620px] mx-auto px-5">
      <motion.p variants={labelSlide} className="section-label mb-4">INITIAL PHASE</motion.p>
      <motion.h2 variants={fadeUp} className="text-[22px] sm:text-[28px] md:text-[32px] font-bold mb-3 text-text-primary">
        Alignment & Scoping
      </motion.h2>
      <motion.p variants={fadeUp} className="text-[14px] text-text-secondary mb-6 leading-relaxed">
