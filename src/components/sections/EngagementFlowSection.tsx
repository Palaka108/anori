...
const EngagementFlowSection = () => (
  <AnimatedSection id="flow">
    <div className="w-full max-w-[620px] mx-auto px-4 sm:px-5">
      <motion.p variants={labelSlide} className="section-label mb-3 sm:mb-4">PROCESS</motion.p>
      ...
      <div className="space-y-0">
        {steps.map((step, i) => (
          <motion.div key={step.num} variants={fadeUp} className="flex items-start gap-3 sm:gap-4">
            {/* Step indicator */}
            ...
            {/* Content */}
            <div className="pt-1.5 pb-4 sm:pb-6">
